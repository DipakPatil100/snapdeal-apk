...
export const Payment = ({ setCartItems }) => {
  const history = useNavigate();
  // const { user } = useAuth0();
  const CARDDATA = JSON.parse(localStorage.getItem("data"));
      ...
      <div className="payment-wrap">
        <div className="paymentLeft">
          <div className="paymentLogin">
            ...
            <h5>
              Logged in as <span>Dummy Mail</span>{" "}
            </h5>
            <a href="#address">
          ...
          <div className="paymentAddress paymentLogin">
            ...
            <a href="#pay">
              <button id="address">SAVE AND CONTINUE</button>
            </a>
          </div>
